...
am_rel_srcdir='.'
am_top_srcdir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/build_dir/host/automake-1.15.1'
am_top_builddir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/build_dir/host/automake-1.15.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/share/automake-1.15/am'
    am_automake_acdir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/share/aclocal-1.15'
    am_bindir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/bin'
    am_datadir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/share'
    am_docdir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/share/doc/automake'
    am_pkgvdatadir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/share/automake-1.15'
    am_scriptdir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/share/automake-1.15'
    am_system_acdir='/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/share/aclocal'
    ;;
  no)
...
EGREP=${AM_TESTSUITE_EGREP-'/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/bin/grep -E'}
FGREP=${AM_TESTSUITE_FGREP-'/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/bin/grep -F'}
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/include '}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-''}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/include '}}
...
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/mnt/sdb/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3/staging_dir/host/include '}}
